...
1. Templates for problem metadata metadata.json, problem definition readme.md and language specific solution and solution test files are available via VSCode snippets. They are all committed and available via the repository itself (.vscode folder). Please familiarize yourself with using snippets in VSCode.
