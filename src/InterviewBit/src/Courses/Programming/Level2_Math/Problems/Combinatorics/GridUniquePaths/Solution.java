package InterviewBit.src.Courses.Programming.Level2_Math.Problems.Combinatorics.GridUniquePaths;
...
public class Solution {
    ...
    public static int findAll(int currentRow, int currentColumn, int rowCount, int colCount, int pathCount, String path) {
    ...
    public static int findAllOptimized(int currentRow, int currentColumn, int rowCount, int colCount, int pathCount, String path) {
		if (currentRow == rowCount - 1) {
            pathCount++;
			return pathCount;
		}
